...
// CSS
import s from './MyLeadPage.scss';
// LANG
import Lang from '../../hoc/Lang/Lang';

class MyLeadPage extends React.Component {
    constructor(props) {
        super(props);
        this.columnDefs = [];
    }
            ...
            <div className="accountForm">
                <div className="header">
                    <div className="contentContainerCenter">
                        <h1>
                            <Lang>locals.leadpage.title.myleads</Lang>
                            <br />
                            <span><Lang>locals.leadpage.titlesmall.yourleadslist</Lang></span>
                        </h1>
                    </div>
                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(MyLeadPage);
